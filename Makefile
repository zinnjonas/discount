CC=gcc -Wno-return-type -Wno-implicit-int -I.
LFLAGS=-L.
CFLAGS=-g
AR=/d/develop/MinGW/bin/ar
RANLIB=/d/develop/MinGW/bin/ranlib
...
install.samples: $(SAMPLE_PGMS) install $(DESTDIR)$(BINDIR)
	...
	/d/develop/discount-2.1.6/config.md $(DESTDIR)$(MANDIR)/man1
	/usr/bin/install -m 444 theme.1 makepage.1 mkd2html.1 $(DESTDIR)$(MANDIR)/man1

install.man:
	/d/develop/discount-2.1.6/config.md $(DESTDIR)$(MANDIR)/man3
	...
	/d/develop/discount-2.1.6/config.md $(DESTDIR)$(MANDIR)/man7
...
$(DESTDIR)$(BINDIR):
	/d/develop/discount-2.1.6/config.md $(DESTDIR)$(BINDIR)

$(DESTDIR)$(INCDIR):
	/d/develop/discount-2.1.6/config.md $(DESTDIR)$(INCDIR)

$(DESTDIR)$(LIBDIR):
	/d/develop/discount-2.1.6/config.md $(DESTDIR)$(LIBDIR)
...
theme:  theme.o $(MKDLIB) mkdio.h
	$(CC) $(LFLAGS) -o theme theme.o pgm_options.o -lmarkdown 
...
makepage:  makepage.c pgm_options.o $(MKDLIB) mkdio.h
	$(CC) $(LFLAGS) -o makepage makepage.c pgm_options.o -lmarkdown 
